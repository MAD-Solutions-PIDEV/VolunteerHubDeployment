...
console.log(id);
    ...
    return (
        <div className="blog-details__main">
            ...
            <Image src={`http://localhost:4000/uploads/${image}`} fluid width="400px" height="300px"/>
            </div>
            <div className="blog-details__content">
            <span style={{ fontSize: '20px' }}>{ deadline ? format(new Date(deadline), 'YYYY-MM-DD') : '' }</span>
                <div className="blog-one__meta">
                    ...
                    <a href="#">
                    <h5><i class="fa fa-bullseye"></i> Goal Amount :{goalAmount} USD</h5>
                    </a>
                    <a href="#">
                    <h5> <i class="fa fa-money"></i> current Amount :{currentAmount} USD </h5>
                    </a>
                </div>
                <h3>{Title}</h3>
                <p>{description}</p>
            ...
            <br></br>
            <div >
                <button  className="main-btn " onClick={() => handleUpdateCampaign(id)}><i className="flaticon-next" ></i>Update Campaign</button>
               
                <button className="main-btn main-btn-2"  onClick={() => handleDeleteCampaign(id)}> Delete Campaign </button>
                </div>
