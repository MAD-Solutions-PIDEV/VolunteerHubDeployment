...
function CreatePost({ username = "" }) {
  ...
  const postNFT = async () => {
    ...
    try {
      const response = await fetch(
        "https://volunteerhub-backend.onrender.com/postNFT",
        {
          method: "POST",
          headers: {
  ...
  const generateImage = async (prompt) => {
    try {
      ...
      setIsLoading(true);
      const response = await fetch(
        "https://volunteerhub-backend.onrender.com/create-post",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                    ...
                    <div className="promptDiv">
                      <form id="imagePrompt">
                        <button onClick={handlePlayerReady}>
                          Play Video and watch what's going on in the
                          background.
                        </button>
                      </form>
                    </div>
