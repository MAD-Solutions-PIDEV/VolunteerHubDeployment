        ...
        <Row>
          <Col lg={7}>
            <div className="project-details-thumb">
              <Image
                src={`https://volunteerhub-backend.onrender.com/uploads/${missionData.Image}`}
                alt="orgLogo"
                fluid
              />
              <div className="">
          ...
          <Col lg={5}>
            <div className="project-details-content  mt-30">
              ...
              <div className="project-details-item"></div>
              ...
              <div className="projects-goal">
                <span>Category : {missionData.Category}</span>
              </div>
              ...
              <div className="project-share d-flex align-items-center"></div>
            </div>
          </Col>
        </Row>
      </Container>
