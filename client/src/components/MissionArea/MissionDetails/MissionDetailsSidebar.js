...
const MissionDetailsSidebar = () => {
  ...
  const handleSave = () => {
    ...
    fetch('http://localhost:4000/missions/api/sendMail/', {
      method: 'POST',
  ...
  return (
    ...
    >
      <div style={{ fontFamily: 'Arial, sans-serif', fontSize: '16px', lineHeight: '1.5' }}>
        <p>We encourage you to reach out to our mission responsible by sending an email to learn more about our mission and how you can get involved.</p>
        <p className="mb-15"> We welcome your participation and look forward to hearing from you.</p>
        <div>
      {/* <div>
...
<div className="input-group">
      ...
      ></textarea>
        ...
        <button className="mt-15 center" onClick={() => {handleSave(); setModalIsOpen(false)();}}>Submit</button>
      </div>
    </Modal>
     ...
     <img src={images['profilepicture.jpg']} alt="" className="mr-100" style={{ width: '100px', height: '100px', }}/> 
      ...
      {startDate && endDate && (
        <>
          <div className="project-details-park mt-30 box">
            <h4 className="title">Start Date</h4>
            <span></span>
            <Calendar className={styles.customcalendar} defaultValue={startDate} />
          </div>

          <div className="project-details-park mt-30 box">
            <h4 className="title">End Date</h4>
            <span></span>
            <Calendar className={styles.customcalendar} defaultValue={endDate} />
          </div>
        </>
      )}
    </div>
