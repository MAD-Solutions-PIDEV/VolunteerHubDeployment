      ...
      <div className="explore-projects-content">
        ...
        <div className="projects-range">
          <div className="projects-range-content">
            ...
            <div className="ProgressBar"><ProgressBar now={Math.floor((currentAmount / goalAmount) * 100)}  /></div>
          </div>
        </div>
        ...
        <Link href="/single-project">
          <p className="title">{description}</p>
            ...
            <br></br>
            <div >
                <button  className="main-btn " onClick={() => handleDonateforCampaign(id)}><i className="flaticon-next" ></i>Donate</button>
