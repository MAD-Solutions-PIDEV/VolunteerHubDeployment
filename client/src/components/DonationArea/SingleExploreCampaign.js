    ...
    <div className="explore-projects-item mt-30">
      ...
      <div className="explore-projects-content">
        <div className="item d-flex align-items-center">
          ...
          <span>Deadline: <br></br>{ deadline ? format(new Date(deadline), 'YYYY-MM-DD') : '' }</span>
        </div>
        <br></br>
        <div className="ProgressBar"><ProgressBar now={Math.floor((currentAmount / goalAmount) * 100)}  /></div>
        <br></br>
        <Link href="#">
        <button className="main-btn main-btn-2" onClick={() => handleDonateforCampaign(campaign._id)} > Donate Now</button>
