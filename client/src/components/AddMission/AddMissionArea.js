...
const AddMissionArea = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (new Date(missionData.StartDate) < currentDate) {
      window.scrollTo(0, 0);
      setNotification({
        message: "Start Date must be after today's date",
        isError: true,
      });
      return;
    }
    ...
    if (
      !missionData.Title.match(lettersRegex) ||
      missionData.Title.length < 3 ||
      missionData.Title.length > 50
    ) {
      window.scrollTo(0, 0);
      let message;
    ...
    try {
      const res = await axios.post(
        "https://volunteerhub-backend.onrender.com/missions",
        formData
      );
                    ...
                    <Col className="form-label form-control form-group">
                      ...
                      <div className="input-box mt-20">
                        ...
                        <input
                          ...
                          defaultValue={missionData.Description}
                          onChange={(e) =>
                            setMissionData({
                              ...missionData,
                      ...
                      <div className="input-box mt-20">
                        ...
                        <input
                          ...
                          defaultValue={missionData.StartDate}
                          onChange={(e) =>
                            setMissionData({
                              ...missionData,
                      ...
                      <div className="input-box mt-20">
                        ...
                        <input
                          ...
                          defaultValue={missionData.EndDate}
                          onChange={(e) =>
                            setMissionData({
                              ...missionData,
                      ...
                      <div className="input-box mt-7">
                        ...
                        <select
                          className={styles.selectMission}
                          defaultValue={missionData.LanguageRequired}
                          onChange={(e) =>
                            setMissionData({
                              ...missionData,
                      ...
                      {!previewUrl && missionData.Image && (
                        <img
                          src={`https://volunteerhub-backend.onrender.com/images/${missionData.Image}`}
                          alt="Current Image"
                          style={{ maxWidth: "100%", height: "auto" }}
                        />
                      )}
