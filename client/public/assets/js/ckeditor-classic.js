		...
		class Kf extends Kl {
			...
			register(t, {
				...
				const r = this.editor,
					s = r.t,
					a = new $l(r.locale);
				if (a.ariaLabel = e || s("av"), this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {
					toolbarId: t
				});
